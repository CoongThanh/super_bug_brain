...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex text-wrap align-items-center" href=" {{ route('dashboard') }} ">
            <img src="{{ asset('assets') }}/img/brain.png" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-2 font-weight-bold text-white">SUPER BUG BRAIN</span>
        </a>
    </div>
    <hr class="horizontal light mt-0 mb-2">
    <div class="collapse navbar-collapse  w-auto" style="height:600px;" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3">
                <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Quản lý</h6>
            </li>
           
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'fieldquestions' ? ' active bg-gradient-primary' : '' }} "
                    href="/fieldquestions">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'questions' ? ' active bg-gradient-primary' : '' }} "
                    href="/questions">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            {{-- <li class="nav-item">
                <a class="nav-link text-white {{ $activePage == 'cards' ? ' active bg-gradient-primary' : '' }} "
                    href="/cards">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">dashboard</i>
                    </div>
                    <span class="nav-link-text ms-1">Thẻ nạp</span>
                </a>
            </li> --}}
            {{-- <li class="nav-item">
